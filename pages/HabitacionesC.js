        ...
        <div className="row">
          ...
          <div className="u8 u12-narrow">
            <div className="row">
              ...
              <div className="u4"><a href="#" className="image fit"><img src="static/images/compartido3.jpg" alt /></a></div>
              ...
              <div className="u4"><a href="#" className="image fit"><img src="static/images/tucan.jpg" alt /></a></div>
              <div className="u4"><a href="#" className="image fit"><img src="static/images/vol2.jpg" alt /></a></div>
